...
export default function Home() {
    ...
    return (
        <>
                ...
                <div id="filters">
                    ...
                    {categories.map((cat) => (
                        ...
                        <Link
                            ...
                            key={cat.value}
                            className={`filter text-decoration-none ${activeCategory === cat.value ? "active-filter" : ""
                                }`}
                        >
            ...
            <div className="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-1 g-4 mt-4 mb-5">
